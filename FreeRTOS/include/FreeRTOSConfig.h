...
/*   FreeRTOS与内存申请有关配置选项   */
/************************************/
#define configAPPLICATION_ALLOCATED_HEAP        0                       //默认情况下，FreeRTOS堆由FreeRTOS声明，并由链接器放置在内存中。允许由应用程序编写器声明堆，这允许应用程序编写器将堆放置在内存中任意位置。
#define configSUPPORT_STATIC_ALLOCATION         1                       //可以使用应用程序编写器提供的RAM创建RTOS对象
#define configSUPPORT_DYNAMIC_ALLOCATION        0                       //支持动态内存申请
